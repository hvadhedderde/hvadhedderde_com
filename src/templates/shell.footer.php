	...
	<div id="navigation">
		<ul>
			...
			<li class="about"><h3><a href="/">About us</a></h3></li>
			<li class="work"><h3><a href="/work">Our work</a></h3></li>
	...
	<div id="footer">
		<div class="vcard company decorate" itemscope itemtype="http://schema.org/Organization">
